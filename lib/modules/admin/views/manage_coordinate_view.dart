            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Name Field
                  const Text('Nama Lokasi / Kantor', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppTheme.textPrimary)),
            ...
            Obx(() {
              if (controller.rxCoordinates.isEmpty) {
                return Container(
                  ...
                  child: const Center(
                    child: Text('Belum ada koordinat kantor tersimpan.', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold)),
                  ),
                );
              }
